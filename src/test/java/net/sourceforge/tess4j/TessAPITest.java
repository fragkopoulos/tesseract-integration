...
//        boxes = api.TessBaseAPIGetRegions(handle, pixa); // equivalent to TessPageIteratorLevel.RIL_BLOCK
    ...
    public void testTessBaseAPIProcessPages() {
        ...
        String outputbase = "src/test/resources/test-results/eurotext";
        ...
        int rc = api.TessBaseAPIProcessPages(handle, imageFile.getPath(), retry_config, timeout_millisec, renderer);
        assertEquals(TRUE, rc);
    }

    /**
     * Test of TessBaseAPIProcessPage method, of class TessAPI.
     */
    @Test
    public void testTessBaseAPIProcessPage() {
        ...
        api.TessBaseAPIInit3(handle, datapath, language);
        TessResultRenderer renderer = api.TessTextRendererCreate(outputbase);
        int rc = api.TessBaseAPIProcessPage(handle, pix, 0, imageFile.getName(), retry_config, timeout_millisec, renderer);
        assertEquals(TRUE, rc);
    }
    ...
    public void testResultRenderer() throws Exception {
        ...
        String outputbase = "src/test/resources/test-results/outputbase";
