...
public class PdfUtilitiesTest {
    ...
    public void testConvertPdf2Tiff() throws Exception {
        ...
        assertTrue(inputPdfFile.exists());
    ...
    public void testSplitPdf() {
        ...
        assertTrue(inputPdfFile.exists());
        File outputPdfFile = new File("src/test/resources/test-results/multipage-pdf_splitted.pdf");
        int startPage = 2;
        int endPage = 3;
        int expResult = 2;
    ...
    public void testMergePdf() {
        ...
        int expResult = 6;
        File outputPdfFile = new File("src/test/resources/test-results", "multipage-pdf_merged.pdf");
